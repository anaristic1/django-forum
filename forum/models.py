...
class Topic(models.Model):
    name = models.CharField(max_length=50, help_text="Name of the topic.")
...
class Post(models.Model):
    ...
    def __str__(self):
        return "{} asked {}".format(self.author.username, self.title)
...
class Comment(models.Model):
    text = models.TextField(max_length=500, help_text="Write your create_comment here.")
    ...
    def get_time(self):
        ...
        return "{} {} ago".format(time, unit_of_time)
